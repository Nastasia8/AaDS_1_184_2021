...
#         a, b = b, a % b
#     return a
# Не проходит по тайм лимиту, если использовать отделньую функцию, как выше, хотя в статичном дереве сработало,
# поэтому погуглил нашел что в библиотеке math есть интерпретация НОД
